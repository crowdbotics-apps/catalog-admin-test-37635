...
## Project Structure
    ...
    ├── catalog_admin_test_37635  # Django project configurations
...
1. Clone this repo and `cd catalog_admin_test_37635`
...
2. Clone this repo and `cd catalog_admin_test_37635`
